...
import io.pivotal.pal.tracker.persistency.InMemoryTimeEntryRepository;
...
public class InMemoryTimeEntryRepositoryTest {
  ...
  @Test public void list() throws Exception {
    ...
    List<TimeEntry> expected = asList(new TimeEntry(1L, 123, 456, LocalDate.parse("2017-01-08"), 8),
        new TimeEntry(2L, 789, 654, LocalDate.parse("2017-01-07"), 4));
    assertThat(repo.list()).isEqualTo(expected);
  }

  @Test public void updateWhenNotFound() throws Exception {
    TimeEntryRepository repo = new InMemoryTimeEntryRepository();
    TimeEntry updatedEntry =
        repo.update(1L, new TimeEntry(321, 654, LocalDate.parse("2017-01-09"), 5));
  ...
  @Test public void update() throws Exception {
    ...
    TimeEntry updatedEntry =
        repo.update(created.getId(), new TimeEntry(321, 654, LocalDate.parse("2017-01-09"), 5));
